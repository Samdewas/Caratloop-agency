...
const DigitalMarketingProject = () => {
    ...
    return (
        <div className="dgm-project-area pb-120 pt-120 fix black-bg-5 section-margin">
                    ...
                    <div className="row align-items-end">
                        ...
                        <div className="col-xl-6 col-lg-6">
                            <div className="dgm-project-top-text mb-30 tp_fade_anim">
                                <p>
                                    Explore how jewelers expand their reach, attract
                                    ideal customers, and increase revenue with our
                                    proven expertise.
                                </p>
                            </div>
                        </div>
