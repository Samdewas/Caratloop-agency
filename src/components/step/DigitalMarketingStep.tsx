                ...
                <div className="row align-items-center">
                    <div className="col-xl-3 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-1 mb-80">
                            ...
                            <p className="dgm-step-subtitle">We migrate your Etsy store to Shopify and deliver your website within 15 days</p>
                            <Link className="tp-btn-yellow-green green-solid mt-25 theme-btn-color" href="/contact">
                                <i>
...
<div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-2 mb-40">
                            <span className="dgm-step-number">01</span>
                            <h4 className="dgm-step-title-sm">Free Store Audit</h4>
                            <p>
...
users and problems
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-3 mb-40">
                            <span className="dgm-step-number">02</span>
                            <h4 className="dgm-step-title-sm">Strategy & Planning</h4>
                            <p>
...
finalize design
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-4 mb-40">
                            <span className="dgm-step-number">03</span>
                            <h4 className="dgm-step-title-sm">Design & Development</h4>
                            <p>
...
maintaining it.
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-2 mb-40">
                            <span className="dgm-step-number">04</span>
                            <h4 className="dgm-step-title-sm">Migration from Etsy</h4>
                            <p>Focussed on understanding
your business requirements,
users and problems </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-3 mb-40">
                            <span className="dgm-step-number">05</span>
                            <h4 className="dgm-step-title-sm">Launch Your Brand</h4>
                            <p>In this stage we work closely to
come up with lots of solutions &
finalize design</p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="dgm-step-item p-relative dgm-step-space-4 mb-40">
                            <span className="dgm-step-number">06</span>
                            <h4 className="dgm-step-title-sm">Growth & Scaling</h4>
                            <p>I develop your product in
Webflow and help you with
maintaining it.</p>
                        </div>
                    </div>
