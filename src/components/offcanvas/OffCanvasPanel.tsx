                ...
                <div className="tp-offcanvas-wrapper @@class offcanvas-white-bg">
                    ...
                    <div className="tp-offcanvas-main">
                        ...
                        <div className="tp-offcanvas-contact">
                            ...
                            <ul>
                                <li><Link href="tel:(+1)2345678910">(+1) 234 567 8910</Link></li>
                                <li><Link href="mailto:hello@design.com">hello@design.com</Link></li>
                                <li><Link href="#">Germany — 482 15h Street, Office 426 Berlin, De 80500</Link></li>
                            </ul>
                        </div>
