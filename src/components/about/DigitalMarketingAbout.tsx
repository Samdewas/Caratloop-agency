"use client"
import aboutImg from "../../../public/assets/img/cartaloop/about-1.png";
import aboutImg2 from "../../../public/assets/img/cartaloop/about-2.png";
...
const DigitalMarketingAbout = () => {
    ...
    return (
        <div className="dgm-about-area dgmm-about-area pt-120 pb-120">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="dgm-about-right">
                                ...
                                <h4 className="tp-section-title-grotesk tp_fade_anim" data-delay=".5">
                                    ...
                                    <span className="p-relative">
                                        ...
                                        <span className="tp-section-title-shape">
                                            <svg width="200" height="15" viewBox="0 0 280 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_5012_164" x1="53.5" y1="18.1094" x2="56.4335" y2="31.6184" gradientUnits="userSpaceOnUse">
                                                        <stop offset="1" stopColor="#E5FE70" />
                                                        <stop offset="1" stopColor="#E5FE70" />
                                                    </linearGradient>
                                                </defs>
                                            </svg>
                            ...
                            <div className="dgm-about-content1">
                                <div className="tp_fade_anim" data-delay=".3">
                                    <p>
                                        CaratLoop helps jewelry businesses grow through premium Shopify websites, ecommerce solutions, and digital marketing. With 10+ years’ experience, we combine luxury design, technology, and performance strategies to build, scale, and drive revenue growth.
                                    </p>
                                </div>
                                <div className="tp_fade_anim" data-delay=".5">
                                    <Link className="tp-btn-yellow-green green-solid theme-btn-color btn-60 mb-50" href="/about-us-light">
                                        <span>
