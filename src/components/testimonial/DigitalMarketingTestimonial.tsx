...
import testBgImg from "../../../public/assets/img/cartaloop/abt-1.png";
...
const DigitalMarketingTestimonial = () => {
    ...
    return (
        <div className="dgm-testimonial-area dgm-testimonial-area-2 dgm-testimonial-radius dgm-testimonial-space mt-120 mb-120 p-relative section-margin">
            ...
            <div className="container-fluid">
                <div className="row justify-content-center">
                    <div className="offset-xl-6 col-xl-6 col-lg-8 col-md-9 pt-100 pb-100">
