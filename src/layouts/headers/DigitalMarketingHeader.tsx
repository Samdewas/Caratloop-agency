"use client"
import logoBlack from "../../../public/assets/img/cartaloop/logo.png";
                    ...
                    <div className="container container-1750">
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-11 col-lg-7 col-7"> */}
                                <div className="tp-header-box d-flex align-items-center justify-content-between justify-content-xl-between">
                                ...
                                <div className="tp-header-menu tp-header-dropdown dropdown-white-bg d-none d-xl-flex">
                                    ...
                                    <div className="tp-header-btn d-none d-md-flex">
                                        <Link className="tp-btn-yellow-green green-solid theme-btn-color" href="/contact">
                                            <i>
